...
@WebServlet("/Postpaid_Prepaid")
public class Postpaid_Prepaid extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse rs) throws ServletException, IOException {
        ...
        String mobno=req.getParameter("postno");
		...
		pw.println("<html>");
		pw.println("<head>");
		pw.println("<title>Mytel Conversion Postpaid to Prepaid</title>");
			 ...
			 PreparedStatement ps=con.prepareStatement("select MOBNO,Typee from mrecharge where MOBNO=?");
		        ...
		        if(res.next()) {
		        	if(res.getString(2).equals("Postpaid")) {
		        		...
		        		pw.println("<div class='row text-center mx-2'><div class='col-6'></div><div class='col-6'><h4 style='color:red;font-family: Times New Roman, Times, serif;'>Your No:"+mobno+" is not a Postpaid No So, You Cannot Convert it to Prepaid <span class='bi bi-x-circle'></span></h4></div></div>");
		        	...
		        	req.getRequestDispatcher("Conversion1.html").include(req, rs);
	        		pw.println("<div class='row text-center mx-2'><div class='col-6'></div><div class='col-6'><h4 style='color:red;font-family: Times New Roman, Times, serif;'>Sorry, You do not have any Postpaid No for Conversion <span class='bi bi-x-circle'></span></h4></div></div>");
	        		req.getRequestDispatcher("Conversion2.html").include(req, rs);
	        		pw.println("<br><div class='row w-100 h-25'><div class='col-6'><img src='other/images/pretopost.jpg' class='rounded-2 m-2 img-thumbnail'></div><div class='col-6'><img src='other/images/postpre.jpg' class='rounded-2 m-2 img-thumbnail'></div></div><br>");
	        		pw.println("<br>");
		        }
